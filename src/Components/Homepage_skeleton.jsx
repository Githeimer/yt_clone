...
const Homepage_skeleton = ({ index }) => {
  return (
    <div
      role="status"
      className="max-w-sm border border-gray-800 rounded-lg p-4 h-fit"
    >
      ...
      <div className=" w-full flex justify-between items-start animate-pulse">
        ...
        <span className="h-2 border-gray-800 rounded-full w-16 "></span>
      </div>
    </div>
  );
};

export default Homepage_skeleton;
